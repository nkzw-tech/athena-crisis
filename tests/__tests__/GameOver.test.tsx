...
test('destroying a building with a neutral unit does not end or crash the game', async () => {
  ...
  expect(
    ...
    `"AttackBuilding (1,1 → 2,1) { hasCounterAttack: false, playerA: 1, building: null, playerC: null, unitA: DryUnit { health: 100, ammo: [ [ 1, 6 ] ] }, unitC: null, chargeA: null, chargeB: 1366, chargeC: 100 }"`,
  );
});

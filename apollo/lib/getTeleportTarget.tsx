...
export default function getTeleportTarget(map: MapData, unit: Unit, to: Vector) {
  ...
  if (nextTile && (!map.buildings.has(nextTile) || unit.info.hasAbility(Ability.AccessBuildings))) {
    return nextTile;
  }

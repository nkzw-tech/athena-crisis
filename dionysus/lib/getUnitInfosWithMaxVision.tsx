...
export default function getUnitInfosWithMaxVision(unitInfosWithWeight: ReadonlyArray<UnitInfo>) {
  const unitInfos = sortBy([...unitInfosWithWeight], ({ configuration: { vision } }) => -vision);

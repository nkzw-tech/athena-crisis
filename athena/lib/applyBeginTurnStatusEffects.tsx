...
export function isPoisoned(map: MapData, player: PlayerOrPlayerID, unit: Unit) {
  return unit.statusEffect === UnitStatusEffect.Poison && map.matchesPlayer(player, unit);
}

export default function applyBeginTurnStatusEffects(map: MapData, player: PlayerOrPlayerID) {
  return map.copy({
